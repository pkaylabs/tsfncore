...
$(document).ready(function() {
    ...
    // Column chart
    if ($('#reports_chart').length > 0) {
        var columnCtx = document.getElementById("reports_chart");
        var rpmData = JSON.parse(document.getElementById("rpm-data").textContent);
        var vrpmData = JSON.parse(document.getElementById("vrpm-data").textContent);

        console.log(rpmData, vrpmData);
        ...
        var columnConfig = {
            ...
            yaxis: {
                title: {
                    text: 'Total Reports Submitted vs Verified'
                }
            },
            fill: {
                opacity: 1
